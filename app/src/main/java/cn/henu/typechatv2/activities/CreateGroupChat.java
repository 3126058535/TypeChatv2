...
import cn.henu.typechatv2.adapter.AddedMembersAdapter;
...
public class CreateGroupChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addedMembersAdapter = new AddedMembersAdapter(addedMembers);
        binding.addedMembers.setAdapter(addedMembersAdapter);
    ...
    private void addMemberToGroup(User user) {
        ...
        addedMembersAdapter.notifyItemInserted(addedMembers.size() - 1);
    }
    ...
    private void createGroupChat() {
        ...
        group.put(Constants.GROUP_CHAT_MEMBERS, new HashMap<>());
