...
public class MessageDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void createUserTable(String userId) {
        ...
        String createTableQuery = "CREATE TABLE IF NOT EXISTS " + "messages_" + userId + "(" +
    ...
    public void addMessage(String userId, String message) {
        ...
        db.insert("messages_" + userId, null, values);
        db.close();
    }
    @Override
...
//    }
    ...
    public List<String> getAllMessages(String userId) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + "messages_" + userId, null);
