...
public class ChatAdapterai extends RecyclerView.Adapter<ChatAdapterai.ViewHolder> {
    ...
    public ChatAdapterai(List<Messageai> messages) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (!message.isUserMessage()) {
            ...
            // 将服务器的消息放在左边
            holder.messageText2.setBackgroundResource(R.drawable.bg_server_message);
